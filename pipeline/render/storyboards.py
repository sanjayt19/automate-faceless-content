...
B["passion"] = board(                                                    # 38
    blk("single", 3, size=(0.15, 0.95), accent=(0.0, 0.25)),
    ...
    blk("single", 3, size=(0.4, 1.0), accent=1.0))
...
B["toolate"] = board(                                                    # 38
    ...
    blk("single", 3, size=(0.45, 1.0), accent=1.0))
...
B["goodatit"] = board(                                                   # 37
    blk("single", 3, size=(0.2, 0.85), accent=(0.0, 0.2)),
...
B["gravity"] = board(                                                    # 38
    blk("single", 3, size=(0.9, 0.35), accent=(0.0, 0.18)),
...
B["threelives"] = board(                                                 # 38
    ...
    blk("single", 4, size=(0.8, 0.2), accent=(0.6, 0.7)),
...
B["degree"] = board(                                                     # 39
    blk("single", 3, size=(0.85, 0.3), accent=(0.0, 0.18)),
