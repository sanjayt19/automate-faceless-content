...
STYLE = (
    ...
    "monochrome halftone archival photo cutouts with rough white keylines and a slightly offset deep "
    "pine green stroke behind each cutout, one single deep pine green accent color per video - a large flat "
    "deep pine green disc behind the main subject and exactly one color-popped hero element among the "
    "monochrome - torn paper edges and tape strips, soft paper drop shadows, hand-drawn deep pine green "
    ...
    "PALETTE LOCK: warm cream paper base, monochrome halftone cutouts, ONE deep pine green accent - no "
